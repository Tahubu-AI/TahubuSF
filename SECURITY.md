...
This document defines security reporting and handling for the TahubuSF project.

## Reporting a Vulnerability

To privately report a security vulnerability in TahubuSF, please create a security advisory in this [repository's Security tab][report-vulnerability].
...
time, please follow up by commenting on the advisory. You can also reach out to the maintainers via the [Tahubu website][https://tahubu.com/contact].
...
[report-vulnerability]: https://github.com/Tahubu-AI/TahubuSF/security/advisories
[security]: https://github.com/Tahubu-AI/TahubuSF/security
